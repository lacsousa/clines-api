...
public class AircraftService {
	...
	public AircraftView showAircraftBy(String code) {
		...
		var aircraft = repository.findByCode(code)
	...
	public String createAircraftBy(AircraftForm form) {
		...
		var model = modelService.findById(form.getModelId())
				.orElseThrow(() -> new AircraftModelNotFoundException("Cannot find aircraft model"));
		form.setModel(model);
